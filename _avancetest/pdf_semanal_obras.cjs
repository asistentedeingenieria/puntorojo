...
/* v1057: los callers pasan la OBRA ELEGIDA (obraPdf) con explicit=true — v1047 revertida */
ok('abrirPdfSemanal pasa la obra elegida + true', (html.match(/_generarPdfSemanal\([^;]*obraPdf,\s*true\)/g)||[]).length>=2);
