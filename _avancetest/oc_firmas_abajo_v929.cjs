...
ok('firma a tamaño fijo sobre su línea (el número exacto lo pinea el test de la versión vigente)', (src.match(/height:\d+px;max-width:2\d\dpx;object-fit:contain/g) || []).length >= 2);
