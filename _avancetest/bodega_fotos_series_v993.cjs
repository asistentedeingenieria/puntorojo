...
const zGen = html.slice(html.indexOf('providerIds.forEach((provId, idx)'), html.indexOf('providerIds.forEach((provId, idx)') + 9000)/* v1201: 2500→5000 herramientas; v1282: →9000, la ORDEN DE RENTA nace dentro del lazo */;
